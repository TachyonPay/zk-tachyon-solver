...
async function main() {
  ...
  // Test with the actual large intent ID from the logs
  const largeIntentId = 287647493468149004223305994324593771393899823137n;
  ...
  console.log(`Testing solveIntentOnChain2 with large intent ID:`);
  console.log(`- Intent ID: ${largeIntentId}`);
  console.log(`- Intent ID as hex: 0x${largeIntentId.toString(16)}`);
  ...
  try {
    const isSolved = await bridge_Base.isIntentSolvedOnChain2(largeIntentId);
